...
export default function Mesection()  {
  ...
  return (
    <section  className="sm:mt-0 text-center bg-neutral-900 bg-opacity-60 ml-10   flex flex-col justify-center text-white m-4 p-3 rounded-3xl ">
      
      <div  className="mt-10 text-violet-400 mb-5  z-10 ">

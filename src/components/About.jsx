...
export default function About() {
  return (
    <div  className='p-4 bg-gradient-to-r from-zinc-800 to-neutral-950'>

    <section  id='about' className="mt-0 overflow-auto text-center container mx-auto m-3 bg-hero-pattern bg-cover bg-center text-white items-center">
      ...
      <div className="mt-10 flex flex-wrap text-center items-center  transition-opacity "> 
       <div className=" mx-auto bg-neutral-900 rounded-lg w-3/12 hover:scale-105 transition-transform hover:shadow-zinc-600 hover:shadow-lg p-3">
